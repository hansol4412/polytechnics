...
<%
	...
	FileReader fl = new FileReader("/var/lib/tomcat9/webapps/ROOT/chapter5/cnt.txt"); 
	...
	FileWriter f12 = new FileWriter("/var/lib/tomcat9/webapps/ROOT/chapter5/cnt.txt", false); 
	f12.write(data); 
	f12.close();
%>
</body>
