...
public class Kopo41_OneRec {
	...
	public Kopo41_OneRec(String kopo41_name, int kopo41_kor, int kopo41_eng, int kopo41_mat) {
		super();
	...
	public double kopo41_avg() { //평균 점수 호출
		return (this.kopo41_kor+this.kopo41_eng+this.kopo41_mat)/3;
	}
}
