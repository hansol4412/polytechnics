...
public class Test7_2 {
	// 20150112(아무 특정일자나)의 모든 종목을 추출하여 파일을 만드시오
	public static void main(String[] args) throws IOException{
		...
		File kopo41_f1 = new File("C:\\Users\\sol\\Desktop\\day_data\\kopo41_20150112.csv"); 
		...
		while((kopo41_readtxt = kopo41_br.readLine())!= null) { 
			...
			if(kopo41_field[1].equals("20150112")) {
				// 1번 인덱스 값이, 날짝가 20150112인 데이터
