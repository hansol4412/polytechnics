...
public class Test8 {
	...
	public static void main(String[] args) {
		int kopo41_iPerson_page = 3; //페이지당 저장소의 크기
		int kopo41_iPerson = 11; //전체 저장소의 크기
		
		DecimalFormat kopo41_df = new DecimalFormat("000");
		...
		for(int kopo41_i=0; kopo41_i<kopo41_iPerson; kopo41_i++) {
			...
			// 점수 정보 출력
			System.out.printf("%3s %7s %6d %6d %6d %8d %8d\n",
		...
		if(kopo41_iPerson%kopo41_iPerson_page!=0) { 
			...
			kopo41_inData.kopo41_page_info(kopo41_iPerson_page*(kopo41_pageNum-2),kopo41_iPerson-1);
			kopo41_printTail();	//총합, 평균 정보 출력
		}	
	}
